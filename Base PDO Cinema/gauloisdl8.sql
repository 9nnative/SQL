...
CREATE DATABASE IF NOT EXISTS `cinemadl8` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `cinemadl8`;

-- Listage de la structure de la table cinemadl8. acteur
...
-- Listage des données de la table cinemadl8.acteur : ~29 rows (environ)
...
-- Listage de la structure de la table cinemadl8. casting
...
-- Listage de la structure de la table cinemadl8. film
CREATE TABLE IF NOT EXISTS `film` (
  ...
  `note_film` int(11) NOT NULL DEFAULT '0',
...
-- Listage de la structure de la table cinemadl8. genre
...
-- Listage de la structure de la table cinemadl8. genre_film
...
-- Listage des données de la table cinemadl8.genre_film : ~61 rows (environ)
...
-- Listage de la structure de la table cinemadl8. realisateur
...
-- Listage des données de la table cinemadl8.realisateur : ~22 rows (environ)
...
-- Listage de la structure de la table cinemadl8. role
